...
<body>
	<div class="container">
		<?php
			...
			if ($ID_directores!='') {
                $sql = "SELECT * FROM tesis where ID_directores='$ID_directores' and ((fecha_propuesta between '$fini' and '$ffin') or(fecha_ent_anteproyecto between '$fini' and '$ffin') or (proyecto between '$fini' and '$ffin' ))";
            ...
            if ($id_area!=="" && $id_eje==0) {
              ...
              $sql = "SELECT * FROM tesis where id_area='$id_area' and (fecha_aprob_propuesta between '$fini' and '$ffin' or fecha_ent_anteproyecto between '$fini' and '$ffin' or proyecto between '$fini' and '$ffin' ) order by fecha_aprob_propuesta";
            ...
            if ($id_eje!=0) {
              ...
              $sql = "SELECT * FROM tesis where id_eje='$id_eje' and (fecha_aprob_propuesta between '$fini' and '$ffin' or fecha_ent_anteproyecto between '$fini' and '$ffin' or proyecto between '$fini' and '$ffin' ) order by fecha_aprob_propuesta";
            ...
            if($id_estudiante2!=="") {
              $sql = "SELECT * FROM tesis where id_estudiante2='$id_estudiante2' and (fecha_aprob_propuesta between '$fini' and '$ffin' or fecha_ent_anteproyecto between '$fini' and '$ffin' or proyecto between '$fini' and '$ffin' ) order by fecha_aprob_propuesta";
