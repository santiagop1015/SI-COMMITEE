...
<body onresize="Evaluar()">
    ...
    <div id="idCard" class="card card-warning" style="margin-bottom: 0px; ">
        ...
        */
        ...
        if (@$_POST['buscar']) {
            $sql=("SELECT * FROM login where user like '%$buscar%' and tipoUsuario='Estudiante'
        ORDER BY Id DESC");
        } else {
         //   @$buscar=$_POST['buscar'];
         $sql=("SELECT * FROM login where tipoUsuario='Estudiante'
...
if(@$_POST['buscar']) {
   /* $sql2=("SELECT * FROM login where user like '%$buscar%' and programa='$programa' and tipoUsuario='Estudiante'
        ORDER BY Id DESC"); 
        */
        $sql2=("SELECT * FROM login where user like '%$buscar%' and tipoUsuario='Estudiante'
        ORDER BY Id DESC");
      //  $total = 1;
} else {
    $sql2=("SELECT * FROM login where tipoUsuario='Estudiante'
    ORDER BY Id DESC");
}
