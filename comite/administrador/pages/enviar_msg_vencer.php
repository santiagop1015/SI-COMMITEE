                        ...
                        <div id="cpestana1">
                            ...
                            <div class="card card-warning">
                                ...
                                <div class="card-body">
                                    ...
                                    $sqltesis = "SELECT * FROM tesis WHERE ID_tesis=$id";
                                    $ressql = mysqli_query($mysqli, $sqltesis);
                                    ...
                                    <form action="enviarmsgusuvencer.php" method="post">
                                        <div class="row">
                                            <div class="col-6">
                                                <label>De:</label>
                                                <input type="text" class="form-control" id="INombre" name="Nombre" value="<?php echo 'Comité proyectos ' . $usuario; ?>" readonly="readonly">
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <label><b>Señor coordinador este mensaje es una notificacion de recordatorio de vencimiento del documento registrado, por parte del estudiante en mención. <br><br> Haga clic en Enviar para hacer efectiva la notificación... </b></label>
                                            </div>
