...
$query = "SELECT * FROM tesis where  terminado='$terminado' and (fecha_propuesta between '$fini' and '$ffin' or fecha_aprob_propuesta between '$fini' and '$ffin' or fecha_ent_anteproyecto between '$fini' and '$ffin' or proyecto between '$fini' and '$ffin' ) order by proyecto asc";
	$resultado = $mysqli->query($query);
	$pdf = new FPDF();
	$pdf->AliasNbPages();
	$pdf->AddPage();
...
//$query = "SELECT * FROM tesis where  id_area='$id_area'";
$query = "SELECT * FROM tesis where  id_area='$id_area' and (fecha_aprob_propuesta between '$fini' and '$ffin' or fecha_ent_anteproyecto between '$fini' and '$ffin' or proyecto between '$fini' and '$ffin' ) order by fecha_aprob_propuesta";
	$resultado = $mysqli->query($query);
	$pdf = new FPDF();
	$pdf->AliasNbPages();
	$pdf->AddPage();
...
//$query = "SELECT * FROM tesis where  id_eje='$id_eje'";
$query = "SELECT * FROM tesis where  id_eje='$id_eje' and (fecha_aprob_propuesta between '$fini' and '$ffin' or fecha_ent_anteproyecto between '$fini' and '$ffin' or proyecto between '$fini' and '$ffin' ) order by fecha_aprob_propuesta";
	$resultado = $mysqli->query($query);
	$pdf = new FPDF();
	$pdf->AliasNbPages();
	$pdf->AddPage();
...
if($id_estudiante2!=="") {
   //echo $id_estudiante2;
   //$query = "SELECT * FROM tesis where  id_estudiante2='$id_estudiante2'";
   $query = "SELECT * FROM tesis where  id_estudiante2='$id_estudiante2' and (fecha_aprob_propuesta between '$fini' and '$ffin' or fecha_ent_anteproyecto between '$fini' and '$ffin' or proyecto between '$fini' and '$ffin' ) order by fecha_aprob_propuesta";
