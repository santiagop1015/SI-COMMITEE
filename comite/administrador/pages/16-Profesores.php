...
<body onresize="Evaluar()">
    ...
    <div id="idCard" class="card card-warning" style="margin-bottom: 0px; ">
        ...
        */
        ...
        if (@$_POST['buscar']) {
            $sql=("SELECT * FROM login where user like '%$buscar%' and (tipoUsuario='Director' or tipoUsuario='Coordinador')
        ORDER BY Id DESC");
        //echo $sql;
        } else {
         //   @$buscar=$_POST['buscar'];
         $sql=("SELECT * FROM login where (tipoUsuario='Director' or tipoUsuario='Coordinador')
...
if(@$_POST['buscar']) {
   /* $sql2=("SELECT * FROM login where user like '%$buscar%' and programa='$programa' and tipoUsuario='Estudiante'
        ORDER BY Id DESC"); 
        */
        $sql2=("SELECT * FROM login where user like '%$buscar%' and (tipoUsuario='Director' or tipoUsuario='Coordinador')
        ORDER BY Id DESC");
      //  $total = 1;
} else {
    $sql2=("SELECT * FROM login where (tipoUsuario='Director' or tipoUsuario='Coordinador')
    ORDER BY Id DESC");
}
