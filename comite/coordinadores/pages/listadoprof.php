...
<div class="card card-danger pt-2 pb-2 pl-2 p" style="width: 1408px;">
        ...
        $total=0;
				  ...
				  $sql=("SELECT * FROM login where  user like '%$buscar%'  and programa='$programa' and (tipoUsuario='Director' or tipoUsuario='Coordinador' ) ORDER BY  Id DESC");
                $query=mysqli_query($mysqli,$sql);
                ...
                ?> 
                    ...
                    <table class="table table-bordered table-striped">
                        <thead>
							...
							<th scope="col">Fc de nacimiento</th>
				...
				$Correo=$arreglo[4];
				 echo "<tr>";
				   ...
				   /*echo "<td><a href='actualizarusercoor.php?id=$arreglo[0]'><img src='images/actualizar.png' width='40'  height='40' class='img-rounded'></td>";*/
					...
					echo "<td><a href='enviar_msg_coor.php?Correo=$arreglo[4]&programa=$programa'><img src='../images/msg.png' width='40'  height='40' class='img-rounded'</td>";
				   echo "</tr>";
				   $total=$total+1;
		   }
				   echo "</tbody></table>";
