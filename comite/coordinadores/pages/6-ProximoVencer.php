    ...
    <div class="card card-warning" style="margin-bottom: 0px; ">
        ...
        <div class="card-body">
            ...
            <div class="box-body table-responsive no-padding">
                ...
                $sql=("SELECT * FROM tesis  where titulo_tesis like '%$buscar%'  and programa='$programa' and (terminado!=0 and terminado != 6 and terminado !=2 and terminado !=7) and (fecha_aprob_propuesta between '$fecha' and '$nuevafecha' or fecha_ent_anteproyecto between '$fecha' and '$nuevafecha' or proyecto between '$fecha ' and '$nuevafecha')  ORDER BY  ID_tesis DESC  ");
            ...
            }else if($arreglo[6]=="Prorroga")
            {
             ...
             echo "<td class='text-center'>
             <a class='btn btn-warning btn-sm' href='6.1-enviar_msg_vencer.php?ID_estudiante=$arreglo[1]&programa=$programa'>
