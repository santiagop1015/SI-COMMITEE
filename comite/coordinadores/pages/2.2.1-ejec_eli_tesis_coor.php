...
utf8_decode(extract($_POST));	//extraer todos los valores del metodo post del formulario de actualizar
	...
	$fecha=date('Y-m-d');
	$hora=date('h:i:s A');
	mysqli_query($mysqli,"INSERT INTO eliminados VALUES('','$usuario','$titulo_tesis','$fecha','$hora')");
              ...
              $sqlborrar="DELETE FROM tesis WHERE ID_tesis='$te'";
	...
	if ($resent==null) {
        ...
        */
		...
		//echo '<script>alert("EL DOCUMENTO FUE BORRADO CON EXITO!")</script> ';
