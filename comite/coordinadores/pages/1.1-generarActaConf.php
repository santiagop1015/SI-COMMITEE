...
//generar acta numero consecutivo
  ...
  $pdf->Output('../../archivos/pdf/'.'as'.$numeroacta.'.pdf', 'F'); 
...
//generar acta numero consecutivo
  ...
  $pdf->Output('../../archivos/pdf/'.'ai'.$numeroacta.'.pdf', 'F'); 
...
//generar acta numero consecutivo
  ...
  $pdf->Output('../../archivos/pdf/'.'am'.$numeroacta.'.pdf', 'F'); 
...
//generar acta numero consecutivo
  ...
  $pdf->Output('../../archivos/pdf/'.'aa'.$numeroacta.'.pdf', 'F'); 
