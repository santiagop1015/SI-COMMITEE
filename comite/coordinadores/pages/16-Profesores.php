...
if(@$_POST['buscar']) {
   /* $sql2=("SELECT * FROM login where user like '%$buscar%' and programa='$programa' and tipoUsuario='Estudiante'
        ORDER BY Id DESC"); 
        */
        $sql2=("SELECT * FROM login where user like '%$buscar%' and programa='$programa' and (tipoUsuario='Director' or tipoUsuario='Coordinador')
        ORDER BY Id DESC");
      //  $total = 1;
} else {
    $sql2=("SELECT * FROM login where programa='$programa' and (tipoUsuario='Director' or tipoUsuario='Coordinador')
    ORDER BY Id DESC");
}
