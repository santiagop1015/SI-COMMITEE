                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="form-control" name="userid"
                                                    value="<?php echo $userid?>" class="Nombre" readonly="readonly">
                                            </div>
                                            <div class="col-6">
                                                <label>Tipo de Usuario: </label>
                                                <select class="form-control" name="tipousuario" required>
                                                    <option value="<?php echo $tipousuario?>"><?php echo $tipousuario?>
                                                    </option>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="form-control" name="user"
                                                    value="<?php echo $user?>" class="Nombre"
                                                    placeholder="Nombres y Apellidos" required>
                                            </div>
                                            <div class="col-6">
                                                <label>Cedula:</label>
                                                <input type="number" class="form-control" name="cedula" class="cedula"
                                                    value="<?php echo $cedula?>" placeholder="Cedula" required>
                                            </div>

                                            <div class="col-6">
                                                <label>Usuario:</label>
                                                <input type="text" class="form-control" name="email" class="Usuario"
                                                    value="<?php echo $email?>" placeholder="Email @unilibre.edu.co"
                                                    required>
                                            </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="form-control" name="password"
                                                    value="<?php echo $pass?>" class="Contraseña"
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="form-control" name="telefono"
                                                    value="<?php echo $telefono?>" class="telefono"
                                            ...
                                            <div class="col-6">
                                                ...
                                                <select class="form-control" name="programa"
                                                    value="<?php echo $programa?>" required>
                                                    <option name="programa" value="<?php echo $programa?>">
                                                        <?php echo $programa?></option>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input type="date" class="form-control" name="fechadenacimiento"
                                                    value="<?php echo $fechadenacimiento?>" id="fechadenacimiento"
