    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #343a40; color: white">
            ...
            <div class="sidebar" style="background-color: #343a40; color: white">
               ...
               with font-awesome or any other icon font library toEstudiante(1); -->

                            <li id="pestana1" class="nav-item">
                                <a href='javascript:toDirector(0);' class="nav-link">
                            ...
                            <li id="pestana2" class="nav-item">
                                <a href='javascript:toDirector(1);' class="nav-link">
                            ...
                            <li id="pestana3" class="nav-item">
                                <a href="javascript:toDirector(2);" class="nav-link">
                            ...
                            <li id="pestana4" class="nav-item">
                                <a href="javascript:toDirector(3);" class="nav-link">
                            ...
                            <li id="pestana5" class="nav-item">
                                <a href="javascript:toDirector(4);" class="nav-link">
                                    <i class="nav-icon fas fa-copy white"></i>
                                    <p class="white">
                                        Proyectos
                                    </p>
                            ...
                            <li id="pestana6" class="nav-item">
                                <a href="javascript:toDirector(5);" class="nav-link">
                                    <i class="nav-icon fa fa-edit white"></i>
                                    <p class="white">
                                        Evaluados
                                    </p>
                            ...
                            <li id="pestana7" class="nav-item">
                                <a href="javascript:toDirector(6);" class="nav-link">
                                    <i class="nav-icon fa fa-book white"></i>
                                    <p class="white">
                                        Actas de Comité
                                    </p>
                            ...
                            <li id="pestana8" class="nav-item">
                                <a href="javascript:toDirector(7);" class="nav-link">
                                    <i class="nav-icon fa fa-edit white"></i>
                                    <p class="white">
                                        Act. Datos
                                    </p>
                            ...
                            <li id="pestana9" class="nav-item">
                                <a href="javascript:toDirector(8);" class="nav-link">
                                    <i class="nav-icon fa fa-user-md white"></i>
                                    <p class="white">
                                        Ayuda
                                    </p>
