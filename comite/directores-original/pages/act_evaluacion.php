                        ...
                        <div id="cpestana1">
                            ...
                            ?>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label>Justificación: Define claramente las razones institucionales,
                                                        sociales,
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label>Marco Referencial: Se hace una revisión literaria y un estado
                                                        del arte de la
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label>Especifica claramente el método a usar para la solución del
                                                        problema? Se describen los instrumentos para poder dar validez y
                                                        condiabilidad a los
